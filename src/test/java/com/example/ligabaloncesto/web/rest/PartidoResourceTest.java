...
public class PartidoResourceTest {
    ...
    public void initTest() {
        partido = new Partido();
        partido.setLocalidad(DEFAULT_LOCALIDAD);
    }
    ...
    public void createPartido() throws Exception {
        ...
        assertThat(testPartido.getLocalidad()).isEqualTo(DEFAULT_LOCALIDAD);
    }
    ...
    public void updatePartido() throws Exception {
        ...
        // Update the partido
        partido.setLocalidad(UPDATED_LOCALIDAD);
        ...
        Partido testPartido = partidos.get(partidos.size() - 1);
        assertThat(testPartido.getLocalidad()).isEqualTo(UPDATED_LOCALIDAD);
    }
