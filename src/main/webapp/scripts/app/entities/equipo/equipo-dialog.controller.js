...
angular.module('ligabaloncestoApp').controller('EquipoDialogController',
    ['$scope', '$stateParams', '$modalInstance', '$q', 'entity', 'Equipo', 'Socio', 'Entrenador', 'Estadio', 'Jugador', 'Temporada', 'Partido',
        function($scope, $stateParams, $modalInstance, $q, entity, Equipo, Socio, Entrenador, Estadio, Jugador, Temporada, Partido) {
