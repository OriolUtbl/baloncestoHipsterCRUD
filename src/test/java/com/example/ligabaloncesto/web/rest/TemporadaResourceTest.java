...
import com.example.ligabaloncesto.repository.TemporadaRepository;
...
public class TemporadaResourceTest {
    ...
    private static final String DEFAULT_ANYO = "SAMPLE_TEXT";
    private static final String UPDATED_ANYO = "UPDATED_TEXT";
    ...
    public void initTest() {
        ...
        temporada.setAnyo(DEFAULT_ANYO);
    }
    ...
    public void createTemporada() throws Exception {
        ...
        assertThat(testTemporada.getAnyo()).isEqualTo(DEFAULT_ANYO);
    }
    ...
    public void updateTemporada() throws Exception {
        ...
        temporada.setAnyo(UPDATED_ANYO);
        ...
        Temporada testTemporada = temporadas.get(temporadas.size() - 1);
        assertThat(testTemporada.getAnyo()).isEqualTo(UPDATED_ANYO);
    }
