...
public class EntrenadorResourceTest {
    ...
    public void initTest() {
        ...
        entrenador.setApellidos(DEFAULT_APELLIDOS);
        entrenador.setFechaNacimiento(DEFAULT_FECHA_NACIMIENTO);
        entrenador.setLocalidad(DEFAULT_LOCALIDAD);
    }
    ...
    public void createEntrenador() throws Exception {
        ...
        assertThat(testEntrenador.getApellidos()).isEqualTo(DEFAULT_APELLIDOS);
        assertThat(testEntrenador.getFechaNacimiento()).isEqualTo(DEFAULT_FECHA_NACIMIENTO);
        assertThat(testEntrenador.getLocalidad()).isEqualTo(DEFAULT_LOCALIDAD);
    }
    ...
    public void updateEntrenador() throws Exception {
        ...
        entrenador.setApellidos(UPDATED_APELLIDOS);
        entrenador.setFechaNacimiento(UPDATED_FECHA_NACIMIENTO);
        entrenador.setLocalidad(UPDATED_LOCALIDAD);
        ...
        assertThat(testEntrenador.getApellidos()).isEqualTo(UPDATED_APELLIDOS);
        assertThat(testEntrenador.getFechaNacimiento()).isEqualTo(UPDATED_FECHA_NACIMIENTO);
        assertThat(testEntrenador.getLocalidad()).isEqualTo(UPDATED_LOCALIDAD);
    }
